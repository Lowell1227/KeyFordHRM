...
const menus = computed<MenuItem[]>(() => {
  ...
  const all: MenuItem[] = [
    ...
    { path: '/tasks', title: '我的绩效', icon: EditPen, group: 'mine' },
    {
      path: '/objectives',
      title: '目标地图',
      icon: Aim,
    ...
    { path: '/probation-reviews/mine', title: '我的试用期考核', icon: EditPen, group: 'mine' },
    {
    ...
    { path: '/confirmation-applications/mine', title: '我的转正申请', icon: EditPen, group: 'mine' },
    {
    ...
    { path: '/templates', title: '考核模板', icon: List, roles: ['hr', 'system_admin'], group: 'templateIndicator' },
    { path: '/indicators', title: '考核指标', icon: OfficeBuilding, roles: ['hr', 'system_admin'], group: 'templateIndicator' },
    {
      path: '/calibration',
      title: '绩效评定',
    ...
    { path: '/appeals', title: '申诉处理', icon: MessageBox, roles: ['hr', 'system_admin'], group: 'performance' },

...
test.describe('08-rbac-responsive employee RBAC', () => {
  ...
  for (const path of ['/cycles', '/templates', '/indicators', '/calibration', '/publish', '/reports', '/users', '/objectives']) {
...
test.describe('08-rbac-responsive manager RBAC', () => {
  ...
  for (const path of ['/cycles', '/templates', '/indicators', '/calibration', '/publish', '/users']) {
...
test.describe('08-rbac-responsive mobile pages', () => {
  ...
  for (const path of ['/dashboard', '/cycles', '/templates', '/reports', '/objectives']) {

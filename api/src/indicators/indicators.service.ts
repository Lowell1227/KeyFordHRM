...
export class IndicatorsService {
  ...
  async create(dto: CreateIndicatorDto, user: AuthUser) {
    ...
    const data: Prisma.IndicatorCreateInput = {
      ...
      targetValue: dto.targetValueText ? null : dto.targetValue !== undefined ? new Prisma.Decimal(dto.targetValue) : undefined,
      targetValueText: dto.targetValueText,
      unit: dto.unit,
  ...
  async update(id: string, dto: UpdateIndicatorDto) {
    ...
    const data: Prisma.IndicatorUpdateInput = {
      ...
      ...(dto.targetValue !== undefined && { targetValue: new Prisma.Decimal(dto.targetValue), targetValueText: null }),
      ...(dto.targetValueText !== undefined && { targetValueText: dto.targetValueText, targetValue: null }),
        ...
        toCreate.map((vr) =>
          this.prisma.indicator.create({
            data: {
              ...
              targetValueText: this.toOptionalString(vr.data.targetValueText),
              unit: vr.data.unit,
              isActive: true,
              creator: { connect: { id: user.id } },
            },

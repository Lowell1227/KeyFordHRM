export const TEST_ACCOUNT_MANIFEST = [
  ...
  { employeeNo: 'VP001', name: '测试·李弘', sysRole: 'vp', roleLabel: '分管领导' },
  { employeeNo: 'MGR001', name: '测试·周强明', sysRole: 'manager', roleLabel: '主管' },
  { employeeNo: 'EMP001', name: '测试·张辰', sysRole: 'employee', roleLabel: '员工一' },
  { employeeNo: 'EMP002', name: '测试·陈铭', sysRole: 'employee', roleLabel: '员工二' },
  { employeeNo: 'EMP003', name: '测试·王敏宁', sysRole: 'employee', roleLabel: '员工三' },
  { employeeNo: 'EMP004', name: '测试·刘扬', sysRole: 'employee', roleLabel: '员工四' },
] as const;
